...
if __name__ == "__main__":
    ...
    for prefix in ['']:  # , 'b']:
        for sub in ['4A_Q_cc']:  # , '2A', '3A', '4A', '5A']:
            ...
            file_lower = os.path.join(save_root,
                                      'var_Current_collector_current_density_lower')
            file_upper = os.path.join(save_root,
                                      'var_Current_collector_current_density_upper')
