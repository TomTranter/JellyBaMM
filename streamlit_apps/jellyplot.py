...
with st.sidebar:
    ...
    if not tesla_tabs:
        ...
        positive_offset = st.slider(
             'Positive tab offset',
             0, nodes_per_layer, 0)
        negative_offset = st.slider(
             'Negative tab offset',
             0, nodes_per_layer, 0)
...
if tesla_tabs:
    ...
    pos_tabs = [positive_offset + (tab_spacing*nodes_per_layer*i) for i in range(num_tabs)]
    neg_tabs = [(Nncc-1-negative_offset) - (tab_spacing*nodes_per_layer*i) for i in range(num_tabs)]
