...
for I_app in [1.0, 2.0, 3.0]:
    ...
    lithiation_neg = spm_sim.solution["X-averaged negative electrode" +
                                      " extent of lithiation"].entries
    lithiation_pos = spm_sim.solution["X-averaged positive electrode" +
                                      " extent of lithiation"].entries
